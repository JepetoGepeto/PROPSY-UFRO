...
const LivingWithSurveyed = () => {
    ...
    return (
        <View className="flex-1 bg-[#5F6896]">
          ...
          <Text className="text-7xl rotate-180 text-[#3E3E44] bg-primary mb-4 p-4 rounded-lg font-bold">¿Con cuantas personas vive actualmente?</Text>
            <TextInput
              className="h-[40] w-2/5 border-[#DCDEE8] text-[#DCDEE8] border rounded-lg px-2 mb-2"
              placeholder="Indique con cuantas personas vive el encuestado"
            ...
            <View className="flex-row space-x-4">
              ...
              <TouchableOpacity className="bg-tertiary rounded-lg w-24 h-24 justify-center items-center" onPress={() => navigation.navigate("Agrupation")}>
