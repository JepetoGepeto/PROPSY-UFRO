...
const EducationalLevelSurveyed = () => {
    ...
    const renderItem = ({ item }) => (
        <TouchableOpacity
        className={`py-4 px-8 rounded-lg my-auto mr-2 ${item.value === educationalLevel ? 'bg-primary' : 'bg-white'}`}
        ...
        <View className="flex-1 bg-[#5F6896] justify-center">
            <View className="flex-1 mt-12 items-center">
                ...
                <View className="flex-row space-x-4">
                    ...
                    <TouchableOpacity className="bg-tertiary rounded-lg w-24 h-24 justify-center items-center" onPress={() => navigation.navigate("EducationIncomplete")}>
