  ...
  return (
    <View className="flex-1 bg-[#5F6896] justify-center">
      <View className="flex-1 mt-12 items-center">
        <Text className="text-7xl rotate-180 text-[#3E3E44] bg-primary mb-4 p-4 rounded-lg font-bold">Ha olvidado alguna cita importante (por ejemplo, juntarse con alguien, una hora al médico o una reunión)</Text>
        <FlatList
          data={options}
