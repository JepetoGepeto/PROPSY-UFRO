...
const Frequency4 = () => {
  ...
  const handleNext = () => {
    ...
    if (answer !== null) {
      ...
      dispatch({ type: 'ADD_ANSWER', questionId: 'frequency4', answer });
      navigation.navigate('Frequency5');
    } else {
  ...
  return (
    <View className="flex-1 bg-[#5F6896] justify-center">
      <View className="flex-1 mt-12 items-center">
        <Text className="text-7xl rotate-180 text-[#3E3E44] bg-primary mb-4 p-4 rounded-lg font-bold">¿Con qué frecuencia ha sentido que nadie lo/a entiende?</Text>
        <FlatList
          data={options}
