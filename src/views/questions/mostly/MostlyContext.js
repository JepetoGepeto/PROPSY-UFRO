...
const MostlyContext = () => {
    ...
    return (
        <View className="flex-1 bg-[#5F6896]">
          ...
          <Text className="text-7xl rotate-180 text-[#3E3E44] bg-primary mb-4 p-4 rounded-lg font-bold">Por favor indique su grado de acuerdo o desacuerdo con las siguientes afirmaciones respecto de las personas mayores (personas de 60 años o más). Si usted tiene 60 años o más, piense en las personas mayores de forma general y no solamente en su propia experiencia.</Text>
