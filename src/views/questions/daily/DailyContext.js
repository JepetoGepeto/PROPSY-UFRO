...
const DailyContext = () => {
    ...
    return (
        <View className="flex-1 bg-[#5F6896]">
          ...
          <Text className="text-7xl rotate-180 text-[#3E3E44] bg-primary mb-4 p-4 rounded-lg font-bold">A continuación, se presenta una serie de situaciones que podrían ocurrir en su vida cotidiana. Lea detenidamente cada una e indique la frecuencia con la que le han ocurrido marcando con una X debajo de la opción que mejor le identifique.</Text>
