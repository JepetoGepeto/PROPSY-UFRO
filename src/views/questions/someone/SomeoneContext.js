...
const SomeoneContext = () => {
    ...
    return (
        <View className="flex-1 bg-[#5F6896]">
          ...
          <Text className="text-7xl rotate-180 text-[#3E3E44] bg-primary mb-4 p-4 rounded-lg font-bold">Lea con atención las siguientes afirmaciones e indique con qué frecuencia le han ocurrido. Indique la opción de respuesta que mejor le represente.</Text>
