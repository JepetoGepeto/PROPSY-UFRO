        ...
        <View className="flex-1 bg-[#5F6896]">
          ...
          <Text className="text-7xl rotate-180 text-[#3E3E44] bg-primary mb-4 p-4 rounded-lg font-bold">¿A qué edad comenzó a fumar?</Text>
            <TextInput
              ...
              placeholder="Indique la edad en que empezo a fumar el encuestado"
            ...
            <View className="flex-row space-x-4">
              ...
              <TouchableOpacity className="bg-tertiary rounded-lg w-24 h-24 justify-center items-center" onPress={() => navigation.navigate("IfExSmokerContext")}>
